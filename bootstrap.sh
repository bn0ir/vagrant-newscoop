...
apt-get install -y nginx libgdbm-dev libncurses5-dev automake libtool bison libffi-dev apache2 git nodejs g++ libjpeg-dev libpng-dev libapache2-mod-php5 php5-cli php5-curl php5-mysql php5-gd php5-intl php5-xcache imagemagick mysql-server

apt-get install -y libapache2-mpm-itk  apache2-mpm-itk
...
#set apache2 configs
rsync -av /vagrant/config/apache2.conf /etc/apache2/sites-available/php.conf
